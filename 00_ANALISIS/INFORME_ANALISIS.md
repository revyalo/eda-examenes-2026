...
## 13. Esqueletos por PDF añadidos

Se ha añadido `06_ESQUELETOS_POR_PDF` para cubrir todos los PDFs de examen detectados fuera de `PDFS/Presentaciones`.
Cada PDF tiene una carpeta propia con `INDICE_EJERCICIOS.md`, nombres explícitos de ejercicio y separación interna entre implementación, casos de uso, teoría o revisión pendiente.
Cuando existía un esqueleto de alumno se ha copiado en `esqueletos_existentes`; las carpetas y ZIPs identificados como soluciones no se han copiado.
