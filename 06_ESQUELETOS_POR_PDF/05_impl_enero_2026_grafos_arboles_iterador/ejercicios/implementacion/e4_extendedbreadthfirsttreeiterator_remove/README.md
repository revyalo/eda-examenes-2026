# E4 - ExtendedBreadthFirstTreeIterator.remove

- PDF original: `PDFS/Implementacion/Implementación - Enunciado.pdf`
- Tipo: `implementacion`
- Estructura de datos principal: arboles e iteradores
- Clase de esqueleto generado: `ExtendedBreadthFirstTreeIteratorRemove`
