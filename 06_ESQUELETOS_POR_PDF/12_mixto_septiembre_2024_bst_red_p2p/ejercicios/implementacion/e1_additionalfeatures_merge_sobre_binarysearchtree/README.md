# E1 - AdditionalFeatures.merge sobre BinarySearchTree

- PDF original: `PDFS/Implementacion y casos de uso/estructuras-de-datos-avanzadas-examen-septiembre-2024-convocatoria.pdf`
- Tipo: `implementacion`
- Estructura de datos principal: arboles binarios de busqueda
- Clase de esqueleto generado: `BSTAdditionalFeaturesMerge`
