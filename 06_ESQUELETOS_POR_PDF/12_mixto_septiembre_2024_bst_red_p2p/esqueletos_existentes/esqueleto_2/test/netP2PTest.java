...
public class netP2PTest {
    ...
    public void testNewNode() throws UnknownHostException{
        ...
        net = inicia();
        assertEquals(1,net.numberOfNodes());
