# E1 - ELHyperGraph / hipergrafo

    - PDF original: `PDFS/Implementacion y casos de uso/examen-de-estructuras-de-datos-avanzadas-junio-2024.pdf`
    - Tipo: `implementacion`
    - Estructura de datos principal: grafos e hipergrafos
    - Clase de esqueleto generado: `ELHyperGraphSkeleton`
