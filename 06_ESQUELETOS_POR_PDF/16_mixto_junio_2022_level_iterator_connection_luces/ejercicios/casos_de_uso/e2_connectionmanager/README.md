# E2 - ConnectionManager

    - PDF original: `PDFS/Implementacion y casos de uso/wuolah-free-EnunciadoJunioUltimaV2-A.pdf`
    - Tipo: `casos_de_uso`
    - Estructura de datos principal: grafos y rutas
    - Clase de esqueleto generado: `ConnectionManagerCasoUso`
