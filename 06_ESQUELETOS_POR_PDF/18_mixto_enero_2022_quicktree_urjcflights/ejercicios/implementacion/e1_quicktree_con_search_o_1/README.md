# E1 - QuickTree con search O(1)

    - PDF original: `PDFS/Implementacion y casos de uso/wuolah-free-Examen-2.pdf`
    - Tipo: `implementacion`
    - Estructura de datos principal: arboles de busqueda y mapas auxiliares
    - Clase de esqueleto generado: `QuickTreeSkeleton`
