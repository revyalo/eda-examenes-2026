# E1 - MoreFunctionality.checkMirror

- PDF original: `PDFS/Implementacion y casos de uso/wuolah-free-Examen-3.pdf`
- Tipo: `implementacion`
- Estructura de datos principal: arboles binarios
- Clase de esqueleto generado: `MoreFunctionalityCheckMirror`
