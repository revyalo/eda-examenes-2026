# E2 - InternalNodeIterator

    - PDF original: `PDFS/Implementacion y casos de uso/wuolah-free-Examen-8.pdf`
    - Tipo: `implementacion`
    - Estructura de datos principal: arboles binarios e iteradores
    - Clase de esqueleto generado: `InternalNodeIteratorSkeleton`
