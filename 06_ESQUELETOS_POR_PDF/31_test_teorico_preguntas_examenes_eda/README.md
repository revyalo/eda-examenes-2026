# Preguntas de examenes EDA

- PDF original: `PDFS/Examenes_test_no_tener_en_cuenta/wuolah-free-preguntas-examenes-EDA.pdf`
- Categoria detectada: **test teorico / no usado para esqueletos de practica**

## Ejercicios detectados

| Id | Nombre del ejercicio | Tipo | Estructuras | Carpeta |
|---|---|---|---|---|
| - | PDF de test/teoria | test_teorico | preguntas de repaso | `respuestas_teoricas/` |
