...
Devolver descendientes exactamente a distancia k de un nodo.

## Qué debe completar el alumno

Completa el método o clase `descendantsAtDistanceK` sin cambiar su firma pública.
