...
Devolver las aristas cuya eliminacion desconecta el grafo.

## Qué debe completar el alumno

Completa el método o clase `bridgesSimpleVersion` sin cambiar su firma pública.
