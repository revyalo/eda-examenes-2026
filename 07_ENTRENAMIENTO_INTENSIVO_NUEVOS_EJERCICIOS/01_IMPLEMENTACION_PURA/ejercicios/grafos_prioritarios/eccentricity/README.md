...
Dado un vertice, devolver la mayor distancia minima desde el a cualquier otro vertice.

## Qué debe completar el alumno

Completa el método o clase `eccentricity` sin cambiar su firma pública.
