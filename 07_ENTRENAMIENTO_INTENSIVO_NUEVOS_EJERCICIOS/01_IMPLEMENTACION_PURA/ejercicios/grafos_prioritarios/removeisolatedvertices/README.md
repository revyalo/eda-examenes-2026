...
Eliminar todos los vertices sin aristas incidentes y devolver cuantos se han eliminado.

## Qué debe completar el alumno

Completa el método o clase `removeIsolatedVertices` sin cambiar su firma pública.
