...
- Dificultad: Alta
- Esqueleto: `01_IMPLEMENTACION_PURA/proyecto_implementacion/src/main/java/es/urjc/grafo/EDA/examen/BetweenLevelsIterator.java`

## Enunciado

Iterador que devuelve nodos entre niveles min y max.

## Qué debe completar el alumno

Completa el método o clase `BetweenLevelsIterator` sin cambiar su firma pública.
