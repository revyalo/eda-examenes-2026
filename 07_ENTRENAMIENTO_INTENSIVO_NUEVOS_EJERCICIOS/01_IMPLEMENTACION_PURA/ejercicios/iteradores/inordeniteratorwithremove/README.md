...
- Dificultad: Alta
- Esqueleto: `01_IMPLEMENTACION_PURA/proyecto_implementacion/src/main/java/es/urjc/grafo/EDA/examen/InordenIteratorWithRemove.java`

## Enunciado

Implementar remove en un iterador inorden.

## Qué debe completar el alumno

Completa el método o clase `InordenIteratorWithRemove` sin cambiar su firma pública.
