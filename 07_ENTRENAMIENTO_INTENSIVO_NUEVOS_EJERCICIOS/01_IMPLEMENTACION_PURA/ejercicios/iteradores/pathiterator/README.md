...
- Dificultad: Muy alta
- Esqueleto: `01_IMPLEMENTACION_PURA/proyecto_implementacion/src/main/java/es/urjc/grafo/EDA/examen/PathIterator.java`

## Enunciado

Iterar desde un nodo hasta la raiz o desde raiz hasta un nodo objetivo.

## Qué debe completar el alumno

Completa el método o clase `PathIterator` sin cambiar su firma pública.
