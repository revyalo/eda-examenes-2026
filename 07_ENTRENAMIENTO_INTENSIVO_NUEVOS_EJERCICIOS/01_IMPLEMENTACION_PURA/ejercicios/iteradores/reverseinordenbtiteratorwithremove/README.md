...
- Estructura: Iterador arbol binario
- Dificultad: Muy alta
- Esqueleto: `01_IMPLEMENTACION_PURA/proyecto_implementacion/src/main/java/es/urjc/grafo/EDA/examen/ReverseInordenBTIteratorWithRemove.java`

## Enunciado

Implementar remove en un iterador inorden inverso.

## Qué debe completar el alumno

Completa el método o clase `ReverseInordenBTIteratorWithRemove` sin cambiar su firma pública.
