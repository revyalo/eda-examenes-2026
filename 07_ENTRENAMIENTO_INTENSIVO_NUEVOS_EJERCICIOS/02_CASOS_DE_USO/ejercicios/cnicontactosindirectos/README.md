# CNI: detector de contactos indirectos
            ...
            - Tipo: caso de uso
            - Clase de esqueleto: `02_CASOS_DE_USO/proyecto_casos_de_uso/src/main/java/es/urjc/grafo/EDA/examen/casos/CNIContactosIndirectos.java`
...
- `registrarContacto`
- `hanInteractuado`
- `posibleCadenaContagio`
- `grupoDeAgente`
- `interaccionesAntesDe`
