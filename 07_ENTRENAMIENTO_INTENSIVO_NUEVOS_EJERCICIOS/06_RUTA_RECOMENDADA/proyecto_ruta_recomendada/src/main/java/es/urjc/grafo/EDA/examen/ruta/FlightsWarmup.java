...
public class FlightsWarmup {
    ...
    public void addElemento(Elemento elemento) {
        ...
        throw new UnsupportedOperationException("TODO: addElemento - URJCFlights con grafo dirigido y escalas");
    }

    public void addRelacion(String a, String b) {
        // TODO: añadir relación dirigida/no dirigida según el caso.
        throw new UnsupportedOperationException("TODO: addRelacion - URJCFlights con grafo dirigido y escalas");
    }
    ...
    public boolean conectadoConLimite(String origen, String destino, int limite) {
        ...
        throw new UnsupportedOperationException("TODO: conectadoConLimite - URJCFlights con grafo dirigido y escalas");
    }

    public Iterable<Elemento> topN(int n) {
        // TODO: devolver ranking usando TreeSet/PriorityQueue según proceda.
        throw new UnsupportedOperationException("TODO: topN - URJCFlights con grafo dirigido y escalas");
    }
}
