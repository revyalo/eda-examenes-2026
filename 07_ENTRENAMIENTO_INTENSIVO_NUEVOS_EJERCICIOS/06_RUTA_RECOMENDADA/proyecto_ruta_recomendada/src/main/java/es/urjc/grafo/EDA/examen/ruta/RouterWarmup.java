...
public class RouterWarmup {
    ...
    public void addElemento(Elemento elemento) {
        ...
        throw new UnsupportedOperationException("TODO: addElemento - URJCNetServices con routers y TTL");
    }

    public void addRelacion(String a, String b) {
        // TODO: añadir relación dirigida/no dirigida según el caso.
        throw new UnsupportedOperationException("TODO: addRelacion - URJCNetServices con routers y TTL");
    }
    ...
    public boolean conectadoConLimite(String origen, String destino, int limite) {
        ...
        throw new UnsupportedOperationException("TODO: conectadoConLimite - URJCNetServices con routers y TTL");
    }

    public Iterable<Elemento> topN(int n) {
        // TODO: devolver ranking usando TreeSet/PriorityQueue según proceda.
        throw new UnsupportedOperationException("TODO: topN - URJCNetServices con routers y TTL");
    }
}
