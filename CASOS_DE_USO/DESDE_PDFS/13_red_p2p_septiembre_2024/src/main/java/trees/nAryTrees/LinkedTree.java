package trees.nAryTrees;

import trees.BreadthFirstTreeIterator;
...
public class LinkedTree<E> implements NAryTree<E> {
    ...
    private class TreeNode<E> implements Position<E> {
         ...
         * Main constructor
         */
        public TreeNode(E e, TreeNode<E> p, List<TreeNode<E>> c) {
            this.element = e;
            this.parent = p;
            this.children = c;
        }
         ...
         */
        public final void setChildren(List<TreeNode<E>> c) {
            children = c;
        }
         ...
         */
        public final void setParent(TreeNode<E> v) {
            parent = v;
        }
    ...
    public Position<E> add(E element, Position<E> p, final int n) {
        ...
        List<TreeNode<E>> l = parent.getChildren();
        if (n > l.size())
            throw new RuntimeException("The element cannot be inserted at the specified position.");
        l.add(n, newNode);
        this.size++;
        return newNode;
    }
    ...
    public void remove(Position<E> p) {
        ...
        Iterator<Position<E>> iterator = new BreadthFirstTreeIterator<>(this, p);
    ...
    public void attach(Position<E> p, NAryTree<E> t) {
        ...
        if (t.getClass()!= this.getClass()) {
            ...
            throw new RuntimeException("Cannot attach a tree t in this root because this tree is not empty");
        }
